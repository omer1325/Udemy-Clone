  ...
  return (
    <div className="flex flex-col items-start mx-8 space-y-3 mt-14 mb-8">
        ...
        <div className="text-left w-full border border-gray-300 p-7">
          ...
          <h3>
            Below you can see some of my projects, already on my YouTube channel
            and also what I'm preparing guys. Subscribe to the channel and click
            the Like button, thanks for the support.
          </h3>
